...
```python file=/concepts/modes_resources/modes_resources.py startafter=start_op_with_resources_example endbefore=end_op_with_resources_example
...
```python file=/concepts/modes_resources/modes_resources.py startafter=start_job_example endbefore=end_job_example
...
```python file=/concepts/modes_resources/modes_resources.py startafter=start_resource_dep_graph endbefore=end_resource_dep_graph
...
```python file=/concepts/modes_resources/modes_resources.py startafter=start_resource_dep_job endbefore=end_resource_dep_job
